...
jQuery(document).ready(function () {
    ...
    jQuery('#fileupload').fileupload({
        ...
        success: function (data) {
            ...
            jQuery('<li class="ui-draggable"><img class="img-thumbnail" id=' + data[1] + ' src="../frames_temp/' + file_name + '" rel="../frames_temp/' + file_name + '" width="50px" height="50px"><div class="c-image-remove" title="Remove image"></div></li>')
