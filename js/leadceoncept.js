...
/////////////37.php////////////////
$(document).ready(function () {
    $("#page_37").click(function () {
        $("div.seconds").replaceWith("<input type='text' id='frametext' class='frametext form-control' maxlength='30' style='text-align:center; width:108%' name='text'/>");
        $("#frametext").focus();
        $("#frametext").css("border","");
        $("#frametext").css("box-shadow","");
    });
    $(".c-text-2").click(function () {
        $("div.seconds").html("<input type='text'  id='frametext' class='frametext form-control' maxlength='30'  style='text-align:center; width:108%' name='text'/>");
    });
});
$(document).on('blur', 'input.frametext', function () {
    var text = $("#frametext").val();
